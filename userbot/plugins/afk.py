"""AFK Plugin for @TechnoUB From UniBorg
Syntax: .afk REASON"""
import asyncio
import datetime
    ...
    if ".afk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
        ...
        try:
            ...
            await borg.send_message(  # pylint:disable=E0602
                ...
                "contact @TechnoUB for more info.\n\n `{}`".format(str(e)),
...
async def on_afk(event):
    ...
    if USER_AFK and not (await event.get_sender()).bot:  # pylint:disable=E0602
        ...
        msg = None
        message_to_reply = f"**My Master is Afk,I am now MOOD OUT AS MY MASTER IS ON AFK. BUT DON'T WORRY **  \nAFKT : `{total_afk_time}`\nReason : {reason}"
